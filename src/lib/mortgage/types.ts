...
export interface Prepayment {
  ...
  /**
   * Как понимать amount:
   *  extra — сумма сверх планового платежа (по умолчанию);
   *  budget — всего плачу в месяц: из суммы уходит плановый платёж (проценты и долг),
   *           остаток гасит долг; если платёж больше суммы, досрочки в этом месяце нет.
   */
  kind?: 'extra' | 'budget';
  /**
